...
```sh
grep -rl 'shopiroller' ./ | xargs sed -i '' 's/shopiroller/{YOUR INTEGRATION NAME}/g'
```
...
Want to contribute? Ping us on `shopiroller` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/shopiroller.git
    cd shopiroller
    ```
...
If you have any questions about this integration we will be happy to answer them on `shopiroller` channel on [our Discord](discord.vuestorefront.io).
