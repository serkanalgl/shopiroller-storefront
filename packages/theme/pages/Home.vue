  ...
  <div id="home">
    ...
    <LazyHydrate when-visible>
      <div class="similar-products">
        <SfHeading title="Similar products" :level="2"/>
        ...
        <SfCarousel class="carousel" :settings="{ peek: 16, breakpoints: { 1023: { peek: 0, perView: 2 } } }">
          ...
          <SfCarouselItem class="carousel__item" v-for="(product, i) in products" :key="i">
            <SfProductCard
              ...
              :is-in-wishlist="productGetters.isInWishlist(product)"
...
import { useProduct, productGetters, useWishlist, wishlistGetters } from '@vue-storefront/shopiroller';
...
export default {
  ...
  setup() {
    ...
    const { search: searchProducts, products } = useProduct('products');
