    ...
    >
      ...
      <template #logo>
        <nuxt-link :to="localePath({ name: 'home' })" class="sf-header__logo">
          <SfImage :src="addBasePath('/icons/logo.svg')" alt="Vue Storefront Next" class="sf-header__logo-image" :width="136" :height="34"/>
        </nuxt-link>
      </template>
      <template #navigation>
...
import { useCart, useUser, cartGetters } from '@vue-storefront/shopiroller';
